...
class LoginAdmin extends Component {
  ...
  componentDidMount() {
    // If logged in and admin navigates to LoginAdmin page, should redirect them to admin_dashboard
  ...
  componentWillReceiveProps(nextProps) {
    if (nextProps.auth.isAuthenticated) {
      this.props.history.push("/admin_dashboard"); // push admin to dashboard when they login
    }

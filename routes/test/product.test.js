...
describe('PRODUCT', () => {
  ...
  beforeAll(() => Product.deleteMany({}, () => {}));

  afterAll(() => Product.deleteMany({}, () => {}));

  describe('POST /api/products/add_product', () => {
    it('should accept and add a valid new product', (done) => request(app)
    ...
    it('Should reject adding a product if missing required fields', (done) => {
      const badDoc = { ...newDoc };
  ...
  describe('GET /api/products/:_id', () => {
    it('should return a product object', (done) => request(app)
    ...
    it('should return a product object with requested :_id', (done) => request(app)
      .get(`/api/products/${testId}`)
      .expect(200)
      .then((res) => {
        const foundDoc = res.body;
    ...
    it('should 400 when requesting a bad :_id', (done) => request(app)
      ...
      .then((res) => {
        expect(res.error.text).toBe(
          `Bad Request: No product found with _id ${badId}`,
        );
        done();
      }));
  });

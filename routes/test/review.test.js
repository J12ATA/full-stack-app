...
describe('REVIEW', () => {
  ...
  const {
    expectedProps, newDoc, userDoc, updateDoc, productDoc,
  } = collection;
  ...
  describe('POST /api/reviews/add_review', () => {
    it('should accept and add a valid new review', (done) => request(app)
  ...
  describe('GET /api/reviews/get_all_reviews', () => {
    it('should return JSON array', (done) => request(app)
      .get('/api/reviews/get_all_reviews')
      .expect(200)
      .then((res) => {
  ...
  describe('GET /api/reviews/:_id', () => {
    it('should return a review object', (done) => request(app)
      .get(`/api/reviews/${testId}`)
      .expect(200)
      .then((res) => {
    ...
    it('should return a review object with requested :_id', (done) => request(app)
      .get(`/api/reviews/${testId}`)
      .expect(200)
      .then((res) => {
        const foundDoc = res.body;
    ...
    it('should 400 when requesting a bad :_id', (done) => request(app)
      ...
      .then((res) => {
        expect(res.error.text).toBe(
          `Bad Request: No review found with _id ${badId}`,
        );
        done();
      }));
  });
